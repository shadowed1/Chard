...
- 0.37 (in progress): `Added ChromeOS 103 support. Thanks to gd_minecraft_programmer for creating that syntax. Fixed chard_bridge_daemon not working on some devices. Added chard_timezone_daemon to keep Chard's timezone synced with ChromeOS'. Added /opt to paths.` <br><br>
<br><br>
