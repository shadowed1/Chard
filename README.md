...
- 0.14: `Greatly increased amount of commands able to run outside of chroot. Created chard_preload generation script. Added specific ways to run chariot checkpoints. Created Chardonnay script to run sommelier and Xwayland natively in ChromeOS. Added HDMI, 3.5mm, and Bluetooth support for Chard Audio controls (chardwire). Added Steam GPU detection script.` <br><br>
