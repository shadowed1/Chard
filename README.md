...
- 0.47 (in progress): `Fixed chard_svg hanging on handbrake svg conversion. Fixed icon path scanning. Fixed Chard Gentoo failing to launch apps via shelf. Fixed typo in Chard Arch quick reinstall.` <br><br>
