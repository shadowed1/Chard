...
- 0.49: `Fixed several typos on Gentoo's Chariot by yesidodo73, iamdays confirming selinux package install was useless and removed, NotRX confirming selinux bug, spotting several Arch Chariot useless packages, bug reports and Steam suggestion. Fixed language setup. Fixed chard run issue for Chard Arch. Added Dynamic LD Preload scan. Fixed Chard Gentoo's XDG_DATA_DIRS.`
