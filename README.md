...
<br><br>
- 0.40 (in progress): `Improved gpu screen recorder installation script. Fixed Discord and Heroic, thanks to VALID for reporting. Fixed Flatpak issue. Adding initial Flatpak Proot support. Adding On-Screen Keyboard support. Adding multi-touchscreen support. Adding External USB/SD install support.` <br><br>
