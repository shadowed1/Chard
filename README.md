...
- 0.27*: `Altered some group ID's to match ChromeOS' and added additional ones. Added sanitization safeguard to .bashrc on uninstall. Added the required sys-apps/shadow dependency for coreutils for Gentoo. Adding Steam support for Gentoo!` <br><br>
*In progress <br><br>
<br>
