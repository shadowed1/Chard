...
- 0.45: (In Progress) `Added dev_install check to avoid breaking its python. Fixed Steam wrapper with Bubblepatch. Added automatic baguette on boot support. Cleaned up chard_shortcut.sh` <br><br>
