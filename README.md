...
- 0.27*: `Moved some installer logic prior to chariot. Added the required sys-apps/shadow dependency for coreutils for Gentoo. Adding Steam support for Gentoo!` <br><br>
*In progress <br><br>
<br>
