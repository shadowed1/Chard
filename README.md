...
- 0.48 (in progress, already added): `Implementing chard_garcon to allow ChromeOS chrome to open links if user prefers. Fixed chard_baguette launching termina as root on boot.` <br><br>
