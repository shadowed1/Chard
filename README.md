...
- 0.10: `Fixed Steam black screen bug on fresh install. Fixed Steam local files window from not expanding. Fixed Steam games having flickering lines bug when paired with multiple display + freesync.` <br><br>
