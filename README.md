...
- 0.38: `Downgrading Flatpak to fix it. The recent patch made it incompatible with chard. Added sober wrapper to automatically fix text issue. Added dbus-launch initialization on startup to fix thunar not opening properly.` <br><br>
<br><br>
