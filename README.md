...
- 0.38 (in progress): `Downgrading Flatpak to fix it. The recent patch made it incompatible with chard. Added sober wrapper to automatically fix text issue.` <br><br>
<br><br>
