...
<br><br>
- 0.40 (in progress): `Improved gpu screen recorder installation script. Fixed Discord and Heroic, thanks to VALID for reporting. Fixed Flatpak issue and added socket detection to prevent override micromanagement. Adding On-Screen Keyboard support. Adding multi-touchscreen support.` <br><br>
