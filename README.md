...
- 0.26: `Fixed Chard Gentoo emerge issues during installer. Replaced chronos with $CHARD_USER variable when creating chroot. Added $CHARD_ROOT environmental variable detection in the installer to auto-fill existing install path rather than rely on default only. Fixed LD_LIBRARY_PATH error.` <br><br>
<br>
