...
- 0.43: `Added .conf removal for chard_startup. Enhanced chard_scale to read display size with modetest and adapt to multiple displays. Added Vulkan support for Apple Silicon. Fixed xfce4 apps.` <br><br>
