...
- 0.36: `Fixed bugs with chard_mesa. Added vulkan_tester script. Improved Flatpak to now support running far more apps. Improved OBS suppport to now handle Vulkan.`
