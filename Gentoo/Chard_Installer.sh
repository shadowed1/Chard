...
sudo chroot $CHARD_ROOT /bin/bash -c "
                        ...
                        getent group 229 >/dev/null     || groupadd -g 229 watchdog 2>/dev/null
                        getent group 418 >/dev/null     || groupadd -g 418 virtaccess 2>/dev/null
                        getent group 20158 >/dev/null     || groupadd -g 20158 iioservice 2>/dev/null
                        getent group 404 >/dev/null     || groupadd -g 404 i2c 2>/dev/null
                        ...
                        getent group 416 >/dev/null     || groupadd -g 416 cros_ec-access 2>/dev/null
                        getent group 228 >/dev/null     || groupadd -g 228 power 2>/dev/null
                        getent group 218 >/dev/null     || groupadd -g 218 bluetooth 2>/dev/null
                        getent group 20182 >/dev/null     || groupadd -g 20182 crosvm-root 2>/dev/null
                        getent group 299 >/dev/null     || groupadd -g 299 crosvm 2>/dev/null
                        getent group 204 >/dev/null     || groupadd -g 204 sshd 2>/dev/null
                        getent group 20148 >/dev/null     || groupadd -g 20148 smdisplay 2>/dev/null
                        getent group 277 >/dev/null     || groupadd -g 277 cups 2>/dev/null
                        getent group 226 >/dev/null     || groupadd -g 226 mtp 2>/dev/null
                        getent group 20187 >/dev/null     || groupadd -g 20187 vtpm 2>/dev/null
                        getent group 20187 >/dev/null     || groupadd -g 20187 vtpm 2>/dev/null
                        getent group 20128 >/dev/null     || groupadd -g 20128 pluginvm 2>/dev/null
                        getent group 20115 >/dev/null     || groupadd -g 20115 seneschal-dbus 2>/dev/null
                        getent group 20114 >/dev/null     || groupadd -g 20114 seneschal 2>/dev/null
                        getent group 20112 >/dev/null     || groupadd -g 20112 vm_cicerone 2>/dev/null
                        getent group 407 >/dev/null     || groupadd -g 407 drm_dp_aux 2>/dev/null
                        getent group 20209 >/dev/null     || groupadd -g 20209 session_manager 2>/dev/null
