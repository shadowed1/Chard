...
echo ""
echo "${RESET}"
echo "${RED}Chard Installed can take ${BOLD}30-240 minutes${RESET}${RED} depending on your CPU and storage speed. Requires ~3 GB of space. Supports ${BOLD}x86_64${RESET}${RED} and ${BOLD}ARM64${RESET}${RED}! ${RESET}"
echo
...
case "$response" in
    ...
    *)
    ...
    echo "${RESET}${MAGENTA}[*] Unmounting active bind mounts in case of reinstall...${RESET}"
            ...
            sudo umount -l "/usr/local/chard/etc/resolv.conf" 2>/dev/null || true
...
if [ ! -f "$BUILD_DIR/$KERNEL_TAR" ]; then
    ...
    echo "${RESET}${YELLOW}[!] Kernel tarball already exists, skipping download."
fi
...
PACKAGES=(
    ...
    "bash-completion|2.15.0|tar.xz|https://github.com/scop/bash-completion/releases/download/2.15.0/bash-completion-2.15.0.tar.xz|bash-completion-2.15.0|gnu"
    ...
    "freetype|2.14.1|tar.xz|https://download.savannah.gnu.org/releases/freetype/freetype-2.14.1.tar.xz|freetype-2.14.1|cmake"
    "graphite2|1.3.14|tgz|https://github.com/silnrsi/graphite/releases/download/1.3.14/graphite2-1.3.14.tgz|graphite2-1.3.14|cmakepython"
    ...
    "lzo|2.10|tar.gz|https://www.oberhumer.com/opensource/lzo/download/lzo-2.10.tar.gz|lzo-2.10|gnu"
    ...
    "libseccomp|2.5gnu).5|tar.gz|https://github.com/seccomp/libseccomp/releases/download/v2.5.5/libseccomp-2.5.5.tar.gz|libseccomp-2.5.5|gnu"
    ...
    "util-macros|1.20.2|tar.xz|https://www.x.org/releases/individual/util/util-macros-1.20.2.tar.xz|util-macros-1.20.2|gnu"
    "smartmontools|7.5|tar.gz|https://downloads.sourceforge.net/project/smartmontools/smartmontools/7.5/smartmontools-7.5.tar.gz|smartmontools-7.5|gnu"
    "xorgproto|2024.1|tar.xz|https://www.x.org/releases/individual/proto/xorgproto-2024.1.tar.xz|xorgproto-2024.1|gnu"
    "xtrans|1.5.2|tar.gz|https://www.x.org/archive/individual/lib/xtrans-1.5.2.tar.gz|xtrans-1.5.2|gnu"
    "xcb-proto|1.17.0|tar.xz|https://xorg.freedesktop.org/archive/individual/proto/xcb-proto-1.17.0.tar.xz|xcb-proto-1.17.0|gnu"
    "libxcb|1.17.0|tar.xz|https://xcb.freedesktop.org/dist/libxcb-1.17.0.tar.xz|libxcb-1.17.0|gnu"
    "xextproto|7.3.0|tar.gz|https://xorg.freedesktop.org/releases/individual/proto/xextproto-7.3.0.tar.gz|xextproto-7.3.0|gnu"
    "libX11|1.8.12|tar.xz|https://www.x.org/releases/individual/lib/libX11-1.8.12.tar.xz|libX11-1.8.12|gnu"
    "libXext|1.3.6|tar.xz|https://www.x.org/releases/individual/lib/libXext-1.3.6.tar.xz|libXext-1.3.6|gnu"
    "libXrender|0.9.11|tar.xz|https://www.x.org/releases/individual/lib/libXrender-0.9.12.tar.xz|libXrender-0.9.12|gnu"
    "libXfixes|6.0.2|tar.xz|https://www.x.org/releases/individual/lib/libXfixes-6.0.2.tar.xz|libXfixes-6.0.2|gnu"
    ...
    "libdrm|2.4.123|tar.xz|https://dri.freedesktop.org/libdrm/libdrm-2.4.123.tar.xz|libdrm-2.4.123|meson"
    "libglvnd|1.7.0|tar.gz|https://sources.voidlinux.org/libglvnd-1.7.0/libglvnd-v1.7.0.tar.gz|libglvnd-1.7.0|gnu"
    "libvdpau|1.5|tar.gz|https://gitlab.freedesktop.org/vdpau/libvdpau/-/archive/1.5/libvdpau-1.5.tar.gz|libvdpau-1.5|gnu"
    "glslang|15.0.0|tar.gz|https://github.com/KhronosGroup/glslang/archive/refs/tags/15.0.0.tar.gz|glslang-15.0.0|cmakeGLS"
    "mesa|24.1.5|tar.xz|https://archive.mesa3d.org/mesa-24.1.5.tar.xz|mesa-24.1.5|meson"
    "glu|9.0.3|tar.xz|https://mesa.freedesktop.org/archive/glu/glu-9.0.3.tar.xz|glu-9.0.3|gnu"
    ...
    "libtool|2.5.4|tar.xz|https://mirrors.ibiblio.org/gnu/libtool/libtool-2.5.4.tar.xz|libtool-2.5.4|gnu"
    "fftw|3.3.10|tar.gz|http://www.fftw.org/fftw-3.3.10.tar.gz|fftw-3.3.10|gnu"
    "libasyncns|0.8|tar.gz|https://github.com/shadowed1/Chard/raw/refs/heads/main/libasyncns_x86_64-0.8.tar.gz|libasyncns-0.8|asyncns86"
    "libasyncns|0.8|tar.gz|https://github.com/shadowed1/Chard/raw/refs/heads/main/libasyncns_ARM64-0.8.tar.gz|libasyncns-0.8|asyncnsARM64"
    "tdb|1.4.14|tar.gz|https://download.samba.org/pub/tdb/tdb-1.4.14.tar.gz|tdb-1.4.14|gnu"
    "check|0.15.2|tar.gz|https://github.com/libcheck/check/releases/download/0.15.2/check-0.15.2.tar.gz|check-0.15.2|gnu"
    ...
    "libiconv|1.18|tar.gz|https://mirrors.kernel.org/gnu/libiconv/libiconv-1.18.tar.gz|libiconv-1.18|gnu"
    ...
    "gvdb|0.52.0|zip|https://github.com/GNOME/gvdb/archive/refs/heads/main.zip|gvdb-main|mesongvdb"
    "gobject-introspection|1.86.0|tar.xz|https://download.gnome.org/sources/gobject-introspection/1.86/gobject-introspection-1.86.0.tar.xz|gobject-introspection-1.86.0|meson"
    "libXau|1.0.12|tar.xz|https://www.x.org/pub/individual/lib/libXau-1.0.12.tar.xz|libXau-1.0.12|gnu"
    "qtbase|6.9.2|tar.xz|https://download.qt.io/archive/qt/6.9/6.9.2/submodules/qtbase-everywhere-src-6.9.2.tar.xz|qtbase-everywhere-src-6.9.2|gnu"
    "qttools|6.9.2|tar.xz|https://download.qt.io/archive/qt/6.9/6.9.2/submodules/qttools-everywhere-src-6.9.2.tar.xz|qttools-everywhere-src-6.9.2|gnuqt"
    "sphinx|7.3.7|tar.gz|https://files.pythonhosted.org/packages/source/s/sphinx/sphinx-7.3.7.tar.gz|sphinx-7.3.7|pythonbuild"
    "graphviz|13.1.2|tar.xz|https://gitlab.com/api/v4/projects/4207231/packages/generic/graphviz-releases/13.1.2/graphviz-13.1.2.tar.xz|graphviz-13.1.2|gnu"
    "vala|0.56.18|tar.xz|https://download.gnome.org/sources/vala/0.56/vala-0.56.18.tar.xz|vala-0.56.18|gnu"
    ...
    "shared-mime-info|2.4|tar.gz|https://gitlab.freedesktop.org/xdg/shared-mime-info/-/archive/2.4/shared-mime-info-2.4.tar.gz|shared-mime-info-2.4|meson"
...
for url in "${ARCH_PKGS[@]}"; do
    ...
    echo "${CYAN}[+] Downloading $FILE_NAME"
    attempt=1
    while true; do
    ...
    echo "${RESET}${YELLOW}[+] Extracting $FILE_NAME"
    case "$DEST" in
        *.zst)
...
sudo mount --make-private /usr/local/chard
...
mountpoint -q "/usr/local/chard/etc/resolv.conf" || sudo mount --bind /etc/resolv.conf /usr/local/chard/etc/resolv.conf
...
export LD_LIBRARY_PATH=\"${LD_LIBRARY_PATH:+$LD_LIBRARY_PATH:}/lib:/lib64:/usr/lib:/usr/lib64:/usr/local/lib:/usr/local/lib64:/usr/lib/gcc/$CHOST/14\"
...
case \"$BUILDSYS\" in
    ...
    cmakepython)
        cd /var/tmp/build/$DIR
        cmake -S . -B build \
              -DCMAKE_INSTALL_PREFIX=/usr/local/chard/usr \
              -DCMAKE_BUILD_TYPE=Release
        cmake --build build -j\"\$(nproc)\"
        cmake --install build
        /usr/bin/python3.13 setup.py build
    ...
    docbook)
        ...
        xmlcatalog --noout --add 'public' \
            ...
            /usr/share/xml/docbook/5.0/catalog.xml 2>/dev/null
        ;;
    *)
...
PYEXEC="/usr/lib/python-exec"
PYVER="python3.13"
PYEXEC_DIR="$PYEXEC/$PYVER"
CHARD_BIN="$CHARD_ROOT/usr/bin"
PORTAGE_PROFILE_DIR="$CHARD_ROOT/etc/portage/make.profile"

if [ -L "$PYEXEC" ] && [ ! -e "$PYEXEC" ]; then
    echo "${YELLOW}[*] Removing broken $PYEXEC ${RESET}"
    sudo rm "$PYEXEC"
fi

sudo mkdir -p "$PYEXEC"

if [ -d "$PYEXEC_DIR" ]; then
    sudo rm -rf "$PYEXEC_DIR"
fi

sudo mkdir -p "$PYEXEC_DIR"
...
for link in "${!SYMLINKS[@]}"; do
    ...
    if [ -f "$CHARD_BIN/$target" ]; then
        sudo ln -s "$CHARD_BIN/$target" "$PYEXEC_DIR/$link"
        echo "${GREEN}[+] Linked $PYEXEC_DIR/$link -> $CHARD_BIN/$target ${RESET}"
    else
        echo "${RED}[!] Missing $CHARD_BIN/$target ${RESET}"
    fi
done

WRAPPERS=(emerge ebuild)
for script in "${WRAPPERS[@]}"; do
    if [ -f "$CHARD_BIN/$script" ]; then
        sudo cp "$CHARD_BIN/$script" "$PYEXEC_DIR/$script"
        sudo chmod +x "$PYEXEC_DIR/$script"
        echo "${GREEN}[+] Copied wrapper $script ${RESET}"
    else
        echo "${RED}[!] Missing wrapper $script ${RESET}"
    fi
done
...
case "$ARCH" in
    x86_64)
        CHOST="x86_64-pc-linux-gnu"
        GCC_PATH="$CHARD_ROOT/usr/$CHOST/gcc-bin/14"
        ;;
    aarch64|arm64)
        CHOST="aarch64-unknown-linux-gnu"
        GCC_PATH="$CHARD_ROOT/usr/$CHOST/gcc-bin/14"
...
PKGDIR="$CHARD_ROOT/var/cache/packages"
PORTAGE_TMPDIR="$CHARD_ROOT/var/tmp"
PORTDIR="$CHARD_ROOT/usr/portage"
SANDBOX="$CHARD_ROOT/usr/bin/sandbox"
CHOST="$CHOST"
CC="$GCC_PATH/$CHOST-gcc"
CXX="$GCC_PATH/$CHOST-g++"
AR="$GCC_PATH/gcc-ar"
NM="$GCC_PATH/gcc-nm"
RANLIB="$GCC_PATH/gcc-ranlib"
STRIP="$CHARD_ROOT/usr/$CHOST/binutils-bin/2.44/strip"
...
if [ ! -d "$PORTAGE_PROFILE_DIR" ]; then
    echo "Creating /usr/local/etc/portage/make.profile..."
...
EOF
    ...
    echo "Portage profile created at $PORTAGE_PROFILE_DIR"
fi
...
cp /usr/local/chard/chardbuild.log /home/chronos/user/MyFiles/Downloads/
