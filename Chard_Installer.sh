...
((THREADS < 1)) && THREADS=1
MAKEOPTS="-j$THREADS"
echo "${YELLOW}[+] Detected $MEM_GB GB RAM → using MAKEOPTS=$MAKEOPTS ${RESET}"
...
echo
echo "emerge --noreplace make"
echo "emerge --noreplace cmake"
echo "emerge --noreplace gcc"
echo "emerge --noreplace gmp"
echo "emerge --noreplace mpfr"
echo "emerge --noreplace binutils"
echo "emerge --noreplace diffutils"
echo "emerge --noreplace openssl"
echo "emerge --noreplace curl"
echo "emerge --noreplace dev-vcs/git"
echo "emerge --noreplace coreutils"
echo "emerge --noreplace perl"
echo "emerge --noreplace Capture-Tiny"
echo "emerge --noreplace Try-Tiny"
echo "emerge --noreplace Config-AutoConf"
echo "emerge --noreplace Test-Fatal"
echo "emerge --noreplace findutils"
echo "emerge --noreplace python"
echo "emerge --noreplace meson"
echo "emerge --noreplace dev-libs/glib"
echo "emerge --noreplace pkg-config"
echo "emerge --noreplace gtest"
echo "emerge --noreplace re2c"
echo "emerge --noreplace dev-build/ninja"
echo "emerge --noreplace docbook"
echo "emerge --noreplace gtk-doc"
echo "emerge --noreplace sys-libs/zlib"
echo "emerge --noreplace libunistring"
echo "emerge --noreplace file"
echo "emerge --noreplace extra-cmake-modules"
echo "emerge --autounmask-write dev-perl/File-LibMagic"
echo "emerge --autounmask-write www-client/firefox"
echo "etc-update"
echo "-3"
echo "dispatch-conf"
echo "emerge --noreplace File-LibMagic"
echo "emerge --noreplace libpsl"
echo "emerge --noreplace expat"
echo "emerge --noreplace duktape"
echo "emerge --noreplace app-arch/brotli"
echo "mv /usr/lib/libcrypt.so /usr/lib/libcrypt.so.bak"
echo "emerge --noreplace dev-lang/rust"
echo "${RESET}${CYAN}"
echo "emerge --noreplace sys-auth/polkit"
echo "emerge --noreplace sys-apps/bubblewrap"
echo "emerge --noreplace app-portage/gentoolkit"
echo "emerge --noreplace x11-base/xorg-drivers"
echo "emerge --noreplace x11-base/xorg-server"
echo "emerge --noreplace x11-base/xorg-apps"
echo "emerge --noreplace x11-libs/libX11"
echo "emerge --noreplace x11-libs/libXft"
echo "emerge --noreplace x11-libs/libXrender"
echo "emerge --noreplace x11-libs/libXrandr"
echo "emerge --noreplace x11-libs/libXcursor"
echo "emerge --noreplace x11-libs/libXi"
echo "emerge --noreplace x11-libs/libXinerama"
echo "emerge --noreplace wayland"
echo "emerge --noreplace wayland-protocols"
echo "emerge --noreplace libxkbcommon"
echo "emerge --noreplace libxkbcommon-x11"
echo "emerge --noreplace gtk+3"
echo "emerge --noreplace xfce4util"
echo "emerge --noreplace xfconf"
echo "emerge --noreplace xdg-desktop-portal"
echo "emerge --noreplace xdg-desktop-portal-wlr"
echo "emerge --noreplace media-libs/mesa"
echo "emerge --noreplace media-libs/mesa-progs"
echo "emerge --noreplace media-sound/pulseaudio"
echo "emerge --noreplace media-sound/alsa-utils"
echo "emerge --noreplace sys-apps/dbus"
echo "emerge --noreplace app-accessibility/at-spi2-core"
echo "emerge --noreplace app-accessibility/at-spi2-atk"
echo "emerge --noreplace media-fonts/fontconfig"
echo "emerge --noreplace media-fonts/dejavu"
echo "emerge --noreplace media-libs/freetype"
echo "emerge --noreplace x11-themes/gtk-engine-murrine"
echo "emerge --noreplace x11-themes/gtk-engines"
echo "emerge --noreplace sys-apps/udisks"
echo "emerge --noreplace sys-power/upower"
echo "emerge --noreplace x11-libs/libnotify"
echo "emerge --noreplace dev-libs/libdbusmenu"
echo "emerge --noreplace x11-libs/libSM"
echo "emerge --noreplace x11-libs/libICE"
echo "emerge --noreplace libwnck"
...
echo "emerge --noreplace dev-libs/appstream-glib"
echo "emerge --noreplace app-crypt/gpgme"
echo "emerge --noreplace dev-libs/json-glib"
echo "emerge --noreplace dev-libs/ostree"
echo "emerge --noreplace sys-apps/xdg-dbus-proxy"
echo "emerge --noreplace x11-libs/gdk-pixbuf"
echo "emerge --noreplace sys-fs/fuse:3"
echo "emerge --noreplace dev-python/pygobject"
echo "emerge --noreplace gnome-base/dconf"
echo "emerge --noreplace sys-libs/libmalcontent"
echo "emerge --noreplace x11-misc/xdg-utils"
echo "emerge --noreplace xinit"
echo "emerge --noreplace xterm"
echo "emerge --noreplace twm"
echo "emerge --noreplace xfce-extra/xfce4-screensaver"
echo "emerge --noreplace xfce-base/xfce4-meta"
echo "cd /tmp"
...
echo "emerge --noreplace www-client/firefox"
echo "emerge --noreplace flatpak"
