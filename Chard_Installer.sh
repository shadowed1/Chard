...
USE="a52 aac acl acpi alsa bindist -bluetooth branding bzip2 cairo cdda cdr cet crypt cube dbus dri dri3 dts encode exif flac gdbm gif gpm gtk gtk3 gui iconv icu introspection ipv6 jpeg jit lcms libnotify libtirpc llvm mad mng mp3 mp4 mpeg multilib ncurses nls ogg opengl openmp opus pam pango pcre pdf png ppds proprietary-codecs pulseaudio qml qt5 qt6 readline sdl seccomp sound spell spirv ssl startup-notification svg tiff truetype udev -udisks unicode -upower usb -utils vorbis vulkan wayland wxwidgets x264 x265 xattr xcb xft xml xv xvid zlib python_targets_python3_13 systemd vpx vaapi vdpau zstd -elogind"
...
CONFIG_DRM_NOUVEAU=CONFIG_$DRM_AMDGPU
