...
echo "    sudo cp /mnt/chromeos/MyFiles/Downloads/chard_icons/chard_bridge_daemon.service /etc/systemd/system/"
echo "fi"
echo "sudo systemctl daemon-reload"
echo "sudo systemctl enable --now chard_bridge_daemon.service"
