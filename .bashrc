...
DEFAULT_USE="X a52 aac acl acpi alsa amd64 bindist bluetooth branding bzip2 cairo cdda cdr cet clang crypt curl cups dbus dri dts dvd dvdr -elogind encode exif extra flac ffmpeg gdbm gif gles2 gpm gstreamer gtk gui iconv icu ipv6 jpeg lcms libnotify libtirpc llvm mad mng mp3 mp4 mpeg multilib ncurses networkmanager nls ogg opengl openmp openssl opus pam pango pcre pdf png policykit pipewire ppds pulseaudio qml qt5 qt6 readline sdl seccomp sound spell ssl startup-notification svg test-rust truetype udev udisks unicode upower usb verify-sig vorbis vulkan wayland webp wifi wxwidgets x264 xattr xcb xft xml xv xvid xwayland zlib python_targets_python3_13"
