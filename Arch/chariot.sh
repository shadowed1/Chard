...
checkpoint_164() {
    ...
    retry_pacman "sudo -E pacman -S --needed --noconfirm git gcc make meson ninja pkgconf python" || return 1
    retry_pacman "sudo -E pacman -S --needed --noconfirm ffmpeg libva libva-utils libdrm mesa mesa-demos vulkan-headers vulkan-icd-loader" || return 1
    retry_pacman "sudo -E pacman -S --needed --noconfirm wayland wayland-protocols libx11 libxcomposite libxrandr libxfixes libxdamage libpulse pipewire dbus libcap" || return 1
...
PY
    ...
    retry_pacman "sudo -E pacman -S --needed --noconfirm gpu-screen-recorder-ui gpu-screen-recorder-notification --assume-installed gpu-screen-recorder=5.13.3" || return 1
