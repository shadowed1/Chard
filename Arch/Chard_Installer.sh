...
echo "${RESET}"
echo ""
echo "${RED}- Chard Arch can take ${BOLD}10 to 60 minutes${RESET}${RED} depending on your CPU and storage speed. Requires ~11 GB of space. Supports ${BOLD}x86_64${RESET}${RED} and ${BOLD}ARM64${RESET}${RED}! ${RESET}"
