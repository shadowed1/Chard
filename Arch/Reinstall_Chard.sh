...
sleep 0.05
sudo curl -fsSL "https://raw.githubusercontent.com/shadowed1/Chard/main/bin/chard_sommelier_mouse_capture_patch.sh"            -o "$CHARD_ROOT/bin/chard_sommelier_mouse_capture_patch" 2>/dev/null
sleep 0.05
...
sudo chmod +x "$CHARD_ROOT/bin/chard_sommelier_mouse_capture_patch"
